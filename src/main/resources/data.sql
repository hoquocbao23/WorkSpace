...
VALUES ( '1990-05-20', '0123456789', 'MORNING', 'example@example.com', 'John Doe', 'MONDAY,TUESDAY, WEDNESDAY', 'BD001', 'ST01', 'ACTIVE','STAFF');
INSERT INTO staff ( date_of_birth, phone_number, work_shift, email, full_name, work_days, building_wsid, user_id, status, role_name)
VALUES ('1990-05-20', '0123456789', 'MORNING', 'example@example.com', 'Marry', 'THURSDAY, FRIDAY, SATURDAY', 'BD001', 'ST02', 'ACTIVE', 'STAFF');
